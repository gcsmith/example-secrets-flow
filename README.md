...
* [`example-secrets-repo`](https://github.com/gcsmith/example-secrets-repo) - the repo containing secret file(s) and a decryption script
* [`example-secrets-flow`](https://github.com/gcsmith/example-secrets-flow) - the repo that will consume the secret file
